...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      settingsSubtitle: "Configure how Dommy behaves on your desktop.",
      ...
      doctorPrivacy: "Privacy notice: this report is generated locally. Dommy does not upload data. User paths and secrets are redacted before copying.",
      ...
      doctorRestartButton: "Restart Dommy",
      doctorRestarting: "Restarting",
      doctorRestartConfirmTitle: "Restart Dommy?",
      doctorRestartConfirmDetail: "Dommy will close and reopen. In-flight requests from your AI coding agents will be dropped. The Doctor window will close as part of the restart.",
      ...
      rowSoundDesc: "Play a chime when Dommy finishes a task or asks for input.",
      rowVolume: "Volume",
      rowVolumeDesc: "Adjust sound effect volume. Disabled when sound effects are off.",
      rowLowPowerIdleMode: "Low power idle",
      rowLowPowerIdleModeDesc: "Pause idle SVG animation after Dommy has been still for a few seconds; activity resumes animation immediately.",
      ...
      rowOpenAtLoginDesc: "Start Dommy automatically when you log in.",
      rowHideBubbles: "Hide bubbles",
      rowHideBubblesDesc: "Hide permission, notification, and update bubbles across Dommy.",
      ...
      placeholderDesc: "This panel will land in a future Dommy release. The plan lives in docs/plans/plan-settings-panel.md.",
      ...
      langJapanese: "日本語",
      themeTitle: "Theme",
      themeSubtitle: "Pick a theme for Dommy. Cards show built-in + capability badges so you can see tracked/static/mini differences before switching.",
    ...
    themeImportUserThemeZip: "Import Dommy theme package (.zip)",
    themeImportUserThemeZipHint: "Dommy theme zip: root or one top-level folder must contain theme.json. Put SVG, GIF, APNG, PNG, WebP, JPG, or JPEG assets in assets/.",
      ...
      animMapSubtitle: "Silence individual interrupt animations. Events still fire — Dommy just skips the visual and sound for the selected states.",
      ...
      aboutFooter: "Dommy is open source. Built with care by the community.",
    ...
    zh: {
      settingsTitle: "设置",
      settingsSubtitle: "配置 Dommy 在桌面上的行为。",
      sidebarGeneral: "通用",
      sidebarTheme: "主题",
      sidebarAnimMap: "动画映射",
      ...
      doctorPrivacy: "隐私说明：诊断报告只在本机生成，Dommy 不会上传数据。复制前会脱敏用户路径和密钥。",
      ...
      doctorRestartButton: "重启 Dommy",
      doctorRestarting: "重启中",
      doctorRestartConfirmTitle: "重启 Dommy？",
      doctorRestartConfirmDetail: "Dommy 会关闭并重新启动。AI coding agent 正在进行的请求会被中断。重启过程中 Doctor 窗口也会一起关闭。",
      ...
      rowSoundDesc: "Dommy 完成任务或需要输入时播放提示音。",
      rowVolume: "音量",
      rowVolumeDesc: "调整音效音量。关闭音效时不可用。",
      rowLowPowerIdleMode: "低功耗 idle",
      rowLowPowerIdleModeDesc: "Dommy 静止几秒后暂停 idle SVG 动画；有活动时会立即恢复动画。",
      ...
      rowOpenAtLogin: "开机自启",
      rowOpenAtLoginDesc: "登录系统时自动启动 Dommy。",
      rowHideBubbles: "隐藏气泡",
      rowHideBubblesDesc: "隐藏 Dommy 的权限、通知和更新气泡。",
      ...
      placeholderDesc: "此面板将在 Dommy 后续版本中加入，规划见 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主题",
      themeSubtitle: "为 Dommy 选择一个主题。卡片会显示内建和能力角标，切换前就能看出 tracked / static / mini 等差异。",
      themeEmpty: "没有可用的主题。",
      themeBadgeBuiltin: "内建",
      themeBadgeActive: "当前",
      themeActionGroupUserThemes: "用户主题",
      themeOpenUserThemesFolder: "打开主题文件夹",
    themeImportUserThemeZip: "导入 Dommy 主题包（.zip）",
    themeImportUserThemeZipHint: "Dommy 主题 zip：根目录或一个顶层文件夹内必须包含 theme.json；素材放在 assets/，可使用 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。",
      ...
      animMapTitle: "动画映射",
      animMapSubtitle: "关掉不想看的打扰动画。事件照样会触发——Dommy 只是不再播放对应的动画和音效。",
      ...
      aboutFooter: "Dommy 是开源项目 · 与社区一起打造。",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / \u9e7f\u9e7f",
      aboutOpenExternalFailed: "无法在浏览器中打开链接。",
    },
    "zh-TW": {
      settingsTitle: "設定",
      settingsSubtitle: "設定 Dommy 在桌面上怎麼動作。",
      sidebarGeneral: "一般",
      sidebarTheme: "主題",
      sidebarAnimMap: "動畫對應",
      ...
      doctorPrivacy: "隱私權聲明：診斷報告只在本機產生，Dommy 不會上傳任何資料。複製前會自動把使用者路徑和金鑰遮起來。",
      ...
      doctorRestartButton: "重新啟動 Dommy",
      doctorRestarting: "重新啟動中",
      doctorRestartConfirmTitle: "重新啟動 Dommy？",
      doctorRestartConfirmDetail: "Dommy 會關掉再開起來。AI coding agent 還在跑的請求會被中斷。重新啟動時 Doctor 視窗也會一起關掉。",
      ...
      rowSoundDesc: "Dommy 完成任務或要等輸入時會播放提示聲。",
      rowVolume: "音量",
      rowVolumeDesc: "調整音效音量。停用音效後無法使用。",
      rowLowPowerIdleMode: "低耗電閒置狀態",
      rowLowPowerIdleModeDesc: "Dommy 不動幾秒後就暫停閒置狀態 SVG 動畫；有活動時立即恢復。",
      ...
      rowOpenAtLoginDesc: "登入系統時自動啟動 Dommy。",
      rowHideBubbles: "隱藏對話框",
      rowHideBubblesDesc: "隱藏 Dommy 的權限、通知和更新對話框。",
      ...
      placeholderDesc: "這個面板會在 Dommy 後續版本加入，規劃見 docs/plans/plan-settings-panel.md。",
      ...
      langJapanese: "日本語",
      themeTitle: "主題",
      themeSubtitle: "幫 Dommy 選擇主題。主題卡會顯示是否為內建主題，以及游標跟隨、靜態、迷你模式等支援項目，方便切換前比較差異。",
      themeEmpty: "沒有主題可以用。",
      themeBadgeBuiltin: "內建",
      themeBadgeActive: "目前",
      themeActionGroupUserThemes: "使用者主題",
      themeOpenUserThemesFolder: "開啟主題資料夾",
    themeImportUserThemeZip: "匯入 Dommy 主題套件（.zip）",
    themeImportUserThemeZipHint: "Dommy 主題 zip：根目錄或單一頂層資料夾裡要有 theme.json；素材放在 assets/，支援 SVG、GIF、APNG、PNG、WebP、JPG、JPEG。",
      ...
      animMapTitle: "動畫對應",
      animMapSubtitle: "關掉不想看的打擾動畫。事件還是會觸發——Dommy 只是不再播對應的動畫和音效。",
      ...
      aboutFooter: "Dommy 是開源專案 · 和社群一起做出來的。",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / 鹿鹿",
      aboutOpenExternalFailed: "無法開啟瀏覽器連結。",
    },
    ko: {
      settingsTitle: "설정",
      settingsSubtitle: "데스크톱에서 Dommy의 동작 방식을 설정합니다.",
      sidebarGeneral: "일반",
      sidebarTheme: "테마",
      ...
      doctorPrivacy: "개인정보 안내: 진단 보고서는 로컬에서 생성됩니다. Dommy는 데이터를 업로드하지 않으며 복사 전에 사용자 경로와 비밀값을 가립니다.",
      ...
      doctorRestartButton: "Dommy 재시작",
      doctorRestarting: "재시작 중",
      doctorRestartConfirmTitle: "Dommy를 재시작할까요?",
      doctorRestartConfirmDetail: "Dommy가 종료된 뒤 다시 실행됩니다. 진행 중인 AI 코딩 에이전트 요청은 중단됩니다. 재시작 중에는 Doctor 창도 함께 닫힙니다.",
      ...
      rowSoundDesc: "Dommy가 작업을 마치거나 입력을 요청할 때 알림음을 재생합니다.",
      rowVolume: "볼륨",
      rowVolumeDesc: "효과음 볼륨을 조절합니다. 효과음이 꺼져 있을 때는 비활성화됩니다.",
      rowLowPowerIdleMode: "저전력 idle",
      rowLowPowerIdleModeDesc: "Dommy가 몇 초 동안 가만히 있으면 idle SVG 애니메이션을 일시 중지하고, 활동이 있으면 즉시 다시 재생합니다.",
      ...
      rowOpenAtLoginDesc: "로그인할 때 Dommy를 자동으로 시작합니다.",
      rowHideBubbles: "말풍선 숨기기",
      rowHideBubblesDesc: "Dommy의 권한, 알림, 업데이트 말풍선을 숨깁니다.",
      ...
      placeholderDesc: "이 패널은 향후 Dommy 릴리스에 추가됩니다. 계획은 docs/plans/plan-settings-panel.md에 있습니다.",
      ...
      langJapanese: "日本語",
      themeTitle: "테마",
      themeSubtitle: "Dommy의 테마를 선택합니다. 카드에는 기본 제공/능력 배지가 표시되어 tracked/static/mini 차이를 미리 볼 수 있습니다.",
      themeEmpty: "사용 가능한 테마가 없습니다.",
      themeBadgeBuiltin: "기본 제공",
      themeBadgeActive: "활성",
      themeActionGroupUserThemes: "사용자 테마",
      themeOpenUserThemesFolder: "테마 폴더 열기",
    themeImportUserThemeZip: "Dommy 테마 패키지 가져오기 (.zip)",
    themeImportUserThemeZipHint: "Dommy 테마 zip: 루트 또는 하나의 최상위 폴더에 theme.json이 있어야 합니다. SVG, GIF, APNG, PNG, WebP, JPG, JPEG 파일은 assets/에 넣으세요.",
      ...
      animMapSubtitle: "개별 인터럽트 애니메이션을 끕니다. 이벤트는 계속 발생하지만 Dommy는 선택한 상태의 화면과 소리만 건너뜁니다.",
      ...
      aboutFooter: "Dommy는 오픈 소스 · 커뮤니티와 함께 만듭니다.",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / \u9e7f\u9e7f",
      aboutOpenExternalFailed: "링크를 브라우저에서 열 수 없습니다.",
    },
    ja: {
      settingsTitle: "設定",
      settingsSubtitle: "Dommy のデスクトップでの動作を設定します。",
      sidebarGeneral: "一般",
      sidebarTheme: "テーマ",
      ...
      doctorPrivacy: "プライバシー: この診断レポートはローカルで生成されます。Dommy はデータをアップロードしません。コピー前にユーザーパスと秘密情報はマスクされます。",
      ...
      doctorRestartButton: "Dommy を再起動",
      doctorRestarting: "再起動中",
      doctorRestartConfirmTitle: "Dommy を再起動しますか？",
      doctorRestartConfirmDetail: "Dommy を終了して再起動します。進行中の AI coding agent リクエストは切断されます。再起動中は Doctor ウィンドウも閉じます。",
      ...
      rowSoundDesc: "Dommy がタスクを完了したとき、または入力を求めたときに音を再生します。",
      rowVolume: "音量",
      rowVolumeDesc: "効果音の音量を調整します。効果音オフの時は無効になります。",
      rowLowPowerIdleMode: "省電力アイドル",
      rowLowPowerIdleModeDesc: "数秒間 Dommy が静止していたら idle SVG アニメーションを停止し、活動が再開すると即座に復帰します。",
      ...
      rowOpenAtLoginDesc: "ログイン時に Dommy を自動起動します。",
      rowHideBubbles: "吹き出しを非表示",
      rowHideBubblesDesc: "Dommy の権限・通知・アップデート吹き出しをまとめて非表示にします。",
      ...
      placeholderDesc: "このパネルは Dommy の今後のリリースで追加されます。計画は docs/plans/plan-settings-panel.md にあります。",
      ...
      langJapanese: "日本語",
      themeTitle: "テーマ",
      themeSubtitle: "Dommy のテーマを選びます。カードには組み込み・能力バッジが表示されるので、tracked / static / mini の違いを切替前に確認できます。",
    ...
    themeImportUserThemeZip: "Dommy テーマパッケージをインポート（.zip）",
    themeImportUserThemeZipHint: "Dommy テーマ zip: ルートまたは 1 つのトップフォルダに theme.json が必要です。SVG、GIF、APNG、PNG、WebP、JPG、JPEG は assets/ に入れてください。",
      ...
      animMapSubtitle: "個別の割り込みアニメーションをオフにできます。イベント自体は発火しますが、Dommy は選択した状態の表示と効果音をスキップします。",
      ...
      aboutFooter: "Dommy はオープンソース。コミュニティと一緒に作っています。",
      aboutEasterEggToast: "\u{1F980} Coding shouldn't feel lonely. — Ruller_Lulu / 鹿鹿",
