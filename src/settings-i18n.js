...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      remoteSshErrForwardFailed: "Remote port unavailable. Try a different Remote Forward Port (23433-23437).",
    ...
    zh: {
      ...
      remoteSshErrForwardFailed: "远端端口不可用。请换一个远端转发端口（23433-23437）。",
    ...
    "zh-TW": {
      ...
      remoteSshErrForwardFailed: "遠端連接埠無法使用。請換一個遠端轉送連接埠（23433-23437）。",
    ...
    ko: {
      ...
      remoteSshErrForwardFailed: "원격 포트를 사용할 수 없습니다. 다른 원격 포워드 포트(23433-23437)를 시도하세요.",
    ...
    ja: {
      ...
      remoteSshErrForwardFailed: "リモートポートが使用できません。別のリモートフォワードポート (23433-23437) を試してください。",
