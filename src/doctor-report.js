...
function formatDiagnosticReport(result, meta = {}) {
  ...
  const lines = [
    "# Dommy Diagnostic Report",
    "",
    `- Generated: ${generatedAt}`,
    `- Dommy version: ${version}`,
  ...
  lines.push(
    "",
    "**Privacy notice**: This report is generated locally. Dommy does not upload any data. User paths are replaced with `~`, and Dommy app paths are replaced with `[APP]`. The report contains no API keys, tokens, conversation content, or document filenames."
  );
